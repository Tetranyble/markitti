                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="item-data">
                                                <img class="profile-image" src="{{asset($user?->photo)}}" alt="{{ $user->fullname }}"></div>
                                        </div><!--//col-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="item-data">{{ $user->longname }}</div>
                                        </div><!--//col-->
                                        <div class="col text-end">
                                            <a class="btn-sm app-btn-secondary" href="#">Change</a>
                                        </div><!--//col-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="item-data">
                                                {{ auth()->user()->storeWebsite() }}
                                            </div>
                                        </div><!--//col-->
                                        <div class="col text-end">
                                            @if(auth()->user()->storeExists())
                                                <a class="btn-sm app-btn-secondary" href="{{route('administration.store.edit', auth()->user()->store)}}">Update</a>
                                            @else
                                                <a class="btn-sm app-btn-secondary" href="{{route('administration.store.create')}}">Create</a>
                                            @endif
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="item-data">{{ auth()->user()->preferences->wantNewsLetter() }}</div>
                                        </div><!--//col-->
                                        <div class="col text-end">
                                            <a class="btn-sm app-btn-secondary" href="#">Change</a>
                                        </div><!--//col-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="item-data">{{ auth()->user()->preferences->wantSmsNotification() }}</div>
                                        </div><!--//col-->
                                        <div class="col text-end">
                                            <a class="btn-sm app-btn-secondary" href="#">Change</a>
                                        </div><!--//col-->
