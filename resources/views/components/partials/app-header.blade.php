            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="app-utilities col-auto">
                    ...
                    <div class="app-utility-item">
                        ...
                        <a href="{{ route('administration.store.show', auth()->user()->store) }}" title="Settings">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    ...
                    <div class="app-utility-item app-user-dropdown dropdown">
                        <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                           role="button" aria-expanded="false"><img src="{{ auth()->user()->photo }}"
                                                                    alt="user profile"></a>
                        <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                            <li><a class="dropdown-item" href="{{ route('accounts.show', auth()->user()) }}">Account</a></li>
                            @if(auth()->user()->storeExists())
                            <li><a class="dropdown-item" href="{{ route('administration.store.show', auth()->user()->store) }}">Settings</a></li>
                            @endif
                            <li>
