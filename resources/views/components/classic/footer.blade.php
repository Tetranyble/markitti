        ...
        <div class="row justify-content-lg-between content-space-t-2 content-space-b-lg-2">
            ...
            <div class="col-md-4 col-lg-2 mb-5 mb-lg-0">
              ...
              <span class="d-flex align-items-center">
                <img class="avatar avatar-xss avatar-circle me-2" src="https://htmlstream.com/preview/front-v4.2/html/assets/vendor/flag-icon-css/flags/1x1/us.svg" alt="Image description" width="16" />
                <span>English (US)</span>
                    ...
                    <div class="dropdown-menu" aria-labelledby="footerSelectLanguage">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            <img class="avatar avatar-xss avatar-circle me-2" src="https://htmlstream.com/preview/front-v4.2/html/assets/vendor/flag-icon-css/flags/1x1/de.svg" alt="Image description" width="16" />
                            <span>Deutsch</span>
                        </a>
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            <img class="avatar avatar-xss avatar-circle me-2" src="https://htmlstream.com/preview/front-v4.2/html/assets/vendor/flag-icon-css/flags/1x1/es.svg" alt="Image description" width="16" />
                            <span>Español</span>
                        </a>
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            <img class="avatar avatar-xss avatar-circle me-2" src="https://htmlstream.com/preview/front-v4.2/html/assets/vendor/flag-icon-css/flags/1x1/cn.svg" alt="Image description" width="16" />
                            <span>中文 (繁體)</span>
                        </a>
                    </div>
                </div>
        ...
        <div class="row align-items-sm-center content-space-1">
            ...
            <div class="col-sm-auto">
                ...
                <ul class="list-inline list-separator">
                    <li class="list-inline-item">
                        <a class="link-sm link-secondary" href="https://htmlstream.com/preview/front-v4.2/html/page-privacy.html">Privacy &amp; policy</a>
                    </li>
                    <li class="list-inline-item">
                        <a class="link-sm link-secondary" href="https://htmlstream.com/preview/front-v4.2/html/page-terms.html">Terms &amp; conditions</a>
                    </li>
                    <li class="list-inline-item">
                        <a class="link-sm link-secondary" href="https://htmlstream.com/preview/front-v4.2/html/page-careers.html">Careers</a>
                    </li>
                </ul>
                <!-- End List -->
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <span class="d-flex justify-content-center align-items-center">
                  <img class="avatar avatar-xss me-2" src="https://htmlstream.com/preview/front-v4.2/html/assets/svg/brands/google-icon.svg" alt="Image Description">
                  Log in with Google
                </span>
                        </a>
            ...
            <div class="modal-footer d-block text-center py-sm-5">
                ...
                <div class="w-85 mx-auto">
                    <div class="row justify-content-between">
                        <div class="col">
                            <img class="img-fluid" src="https://htmlstream.com/preview/front-v4.2/html/assets/svg/brands/gitlab-gray.svg" alt="Logo">
                        </div>
                        <!-- End Col -->

                        <div class="col">
                            <img class="img-fluid" src="https://htmlstream.com/preview/front-v4.2/html/assets/svg/brands/fitbit-gray.svg" alt="Logo">
                        </div>
                        <!-- End Col -->

                        <div class="col">
                            <img class="img-fluid" src="https://htmlstream.com/preview/front-v4.2/html/assets/svg/brands/flow-xo-gray.svg" alt="Logo">
                        </div>
                        <!-- End Col -->

                        <div class="col">
                            <img class="img-fluid" src="https://htmlstream.com/preview/front-v4.2/html/assets/svg/brands/layar-gray.svg" alt="Logo">
                        </div>
                        <!-- End Col -->
                    </div>
                </div>
...
<script src="{{asset('classic/js/vendor.min.js')}}"></script>

<!-- JS Front -->
<script src="{{asset('classic/js/theme.min.js')}}"></script>
